...
public class Feedback_testcases extends BrowserFactory{
	
	@Test
	public void validateSubmitingFeedbackSuccesfully_testcase() throws InterruptedException
	{
		...
		mbpa.clickFeedbackFromMenubarAction();
	}
